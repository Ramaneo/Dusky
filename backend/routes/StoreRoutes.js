...
const {getLocalStores,getStoreData, getSubscribedStores,verifyDiscountCode} = require ('../controllers/StoreController')
...
router.post('/verify-discount-code', verifyDiscountCode);
